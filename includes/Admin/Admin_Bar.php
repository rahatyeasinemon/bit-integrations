...
class Admin_Bar
{
    public function register()
    {
        ...
        // Hooks::add('admin_enqueue_scripts', [$this, 'AdminAssets'], 9);
        Hooks::filter('btcbi_localized_script', [$this, 'filterAdminScriptVar']);
        // Hooks::filter('script_loader_tag', [$this, 'scriptTagFilter'], 0, 3);
    }
    ...
    public function AdminMenu()
    {
        ...
        if (Capabilities::Check($capability)) {
            ...
            add_menu_page(__('Integrations for WordPress Forms', 'bit-integrations'), 'Bit Integrations Pro', $capability, 'bit-integrations', '', 'data:image/svg+xml;base64,' . base64_encode('<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                '), 30);
            $submenu['bit-integrations'][] = [__('All Integrations', 'bit-integrations'), $capability, 'admin.php?page=bit-integrations#/'];
        }
    }
