...
final class Updater
{
    ...
    public function __construct()
    {
        ...
        $this->_name = plugin_basename(BTCBI_PLUGIN_MAIN_FILE);
        $this->_version =  BTCBI_VERSION;
    ...
    public function licenseMenu()
    {
        ...
        $subMenupage = add_submenu_page(
            'bit-integrations',
            'license page | Bit Integrations Connect Wordpress Plugins And External Applications',
            'License',
            'manage_options',
            ...
            function () {
                ...
                if (!empty($integrateStatus) && is_array($integrateStatus) && $integrateStatus['status'] === 'success') {
                    include_once BTCBI_PLUGIN_DIR_PATH . '/views/license/status.php';
                } else {
                    include_once BTCBI_PLUGIN_DIR_PATH . '/views/license/add.php';
                }
            }
        );
    }
