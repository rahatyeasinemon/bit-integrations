...
use BitCode\BTCBI\Http\Services\Actions\ZohoCRM\FilesApiHelper;
...
class RecordApiHelper
{
    ...
    public function execute($integId, $defaultConf, $module, $layout, $fieldValues, $fieldMap, $actions, $required, $fileMap = [], $isRelated = false)
    {
        ...
        if (
            ...
            if (!empty($actions->tag_rec) && class_exists('BitCode\BTCBI\Http\Services\Actions\ZohoCRM\TagApiHelper')) {
                $tags = '';
