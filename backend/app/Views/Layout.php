...
class Layout
{
    public function register()
    {
        ...
        Hooks::addAction('admin_menu', [$this, 'AdminMenu']);
        Hooks::addAction('admin_enqueue_scripts', [$this, 'AdminAssets']);
        // Hooks::addFilter('btcbi_localized_script', [$this, 'filterAdminScriptVar']);
    ...
    {
        $capability = Hooks::applyFilter('manage_wp_integrations', 'manage_options');
