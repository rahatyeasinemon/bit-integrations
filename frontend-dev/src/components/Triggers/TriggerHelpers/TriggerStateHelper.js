...
export const wpForoStateFP = (val, tmpNewFlow, resp, setNewFlow) => {
  ...
  if (val === 'wpforo-2' || val === 'wpforo-3' || val === 'wpforo-4' || val === 'wpforo-5' || val === 'wpforo-6' || val === 'wpforo-11') {
    tmpNewFlow.triggerData = {
      ...tmpNewFlow.triggerData,
  ...
  if (val === 'wpforo-7' || val === 'wpforo-8' || val === 'wpforo-9' || val === 'wpforo-10' || val === 'wpforo-12') {
    tmpNewFlow.triggerData = {
      ...tmpNewFlow.triggerData,
...
export const WooCommerceStateFP = (val, tmpNewFlow, resp, setNewFlow) => {
  ...
  if (val === "17") {
    tmpNewFlow.triggerData.allProductCategories =
      resp.data.allProductCategories;
  }
  if (val === "20") {
...
export const wpForoStateIH = (tmpConf, flowData, triggered_entity_id) => {
  ...
  if (formId === 'wpforo-2' || formId === 'wpforo-3' || formId === 'wpforo-4' || formId === 'wpforo-5' || formId === 'wpforo-6' || formId === 'wpforo-11') {
    tmpConf.selectedTopic = flowData.selectedTopic
    tmpConf.topics = flowData.topics
  }

  if (formId === 'wpforo-7' || formId === 'wpforo-8' || formId === 'wpforo-9' || formId === 'wpforo-10' || formId === 'wpforo-12') {
...
export const wpCoursewareStateIH = (tmpConf, flowData) => {
  if (
    flowData.formID === "userEnrolledCourse" ||
    flowData.formID === "courseCompleted"
  ) {
    tmpConf.selectedCourse = flowData?.selectedCourse;
...
export const GiveWpStateIH = (tmpConf, flowData) => {
  ...
  if (val === 2) {
    tmpConf.selectedRecurringDonationForm =
      flowData.selectedRecurringDonationForm;
