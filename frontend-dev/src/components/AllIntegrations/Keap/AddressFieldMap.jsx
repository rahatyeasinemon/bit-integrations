  ...
  return (
    <div className="flx mt-2 mb-2 btcbi-field-map">
      <select
        ...
        onChange={(ev) => handleAddress(ev, i, sheetConf, setSheetConf)}>
      ...
      <select
        ...
        onChange={(ev) => handleAddress(ev, i, sheetConf, setSheetConf, addressField)}
        disabled={isRequired}>
        <option value="">{__('Select Field', 'bit-integrations')}</option>
        {isRequired
      ...
      {!isRequired && (
        <button
          onClick={() => delAddressFieldMap(i, sheetConf, setSheetConf)}
