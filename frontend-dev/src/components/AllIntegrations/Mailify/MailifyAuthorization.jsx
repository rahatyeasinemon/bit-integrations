...
export default function MailifyAuthorization({
  ...
  const ActiveInstructions = `
            ...
            <ul>
                ...
                <li>${__('Click on the "Settings" from Top-Right corner dropdown', 'bit-integrations')}</li>
                <li>${__('Then Click "Developers", Then click "Add an Api Key"', 'bit-integrations')}</li>
            </ul>`
