    ...
    <>
      ...
      <>
        ...
        <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
          ...
          <div className="txt-dp"><b>{__('Freshdesk Ticket Fields', 'bit-integrations')}</b></div>
        </div>
        ...
        {freshdeskConf.contactShow && !isLoading &&
          <>
            <div className="mt-4">
              <b className="wdt-100">{__('Map Fields', 'bit-integrations')}</b>
              <button onClick={() => getAllContactFields(freshdeskConf, setFreshdeskConf, setIsLoading, setSnackbar)} className="icn-btn sh-sm ml-2 mr-2 tooltip" style={{ '--tooltip-txt': `'${__('Refresh Contact Field', 'bit-integrations')}'` }} type="button" disabled={isLoading}>&#x21BB;</button>
            </div>
            <div className="btcd-hr mt-1" />
            <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
              <div className="txt-dp"><b>{__('Form Fields', 'bit-integrations')}</b></div>
              <div className="txt-dp"><b>{__('Freshdesk Contact Fields', 'bit-integrations')}</b></div>
            </div>
        ...
        {freshdeskConf.contactShow && !isLoading && <div className="txt-center btcbi-field-map-button mt-2"><button onClick={() => addContactFieldMap(freshdeskConf.field_map_contact.length, freshdeskConf, setFreshdeskConf)} className="icn-btn sh-sm" type="button">+</button></div>}
        <br />
        <br />
