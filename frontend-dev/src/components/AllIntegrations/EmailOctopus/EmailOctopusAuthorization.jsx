...
export default function EmailOctopusAuthorization({ emailOctopusConf, setEmailOctopusConf, step, setStep, loading, setLoading, isInfo }) {
  ...
  return (
    <div className="btcd-stp-page" style={{ ...{ width: step === 1 && 900 }, ...{ height: step === 1 && 'auto' } }}>
      ...
      {!isInfo && (
        <div>
          <button onClick={() => emailOctopusAuthentication(emailOctopusConf, setEmailOctopusConf, setError, setIsAuthorized, loading, setLoading, 'authentication')} className="btn btcd-btn-lg green sh-sm flx" type="button" disabled={isAuthorized || loading.auth}>
