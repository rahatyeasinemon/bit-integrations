...
export default function FreshSalesActions({
  freshSalesConf,
  setFreshSalesConf,
  tab,
  isLoading,
  ...
  const module =
    tab === 0 ? freshSalesConf.moduleData.module : freshSalesConf.relatedlists?.[tab - 1]?.module
  ...
  const actionHandler = (e, type) => {
    ...
    if (tab === 0) {
      ...
      if (type === 'busy_flag' || type === 'active_flag' || type === 'upsert') {
        if (e.target.checked) {
    ...
    <>
      <div className="pos-rel d-flx w-8">
        <TableCheckBox
          checked={
            (tab === 0
              ? freshSalesConf.moduleData?.owner
              : freshSalesConf.relatedlists[tab - 1].moduleData?.owner) || false
          }
        ...
        {module === 'Leads' && (
          <>
            {' '}
            <TableCheckBox
              checked={freshSalesConf.moduleData?.lead_label || false}
            ...
            />
            <TableCheckBox
              checked={freshSalesConf.moduleData?.currency || false}
        ...
        {module === 'Deal' && (
          <>
            <TableCheckBox
              checked={freshSalesConf.moduleData?.deal_stage || false}
            ...
            />
            <TableCheckBox
              checked={freshSalesConf.moduleData?.deal_status || false}
        ...
        {module === 'Activities' && (
          <>
            <TableCheckBox
              checked={
                (tab === 0
                  ? freshSalesConf.moduleData?.activities_type
                  : freshSalesConf.relatedlists[tab - 1]?.moduleData?.activities_type) || false
              }
            ...
            <TableCheckBox
              checked={
                (tab === 0
                  ? freshSalesConf.actions?.busy_flag
                  : freshSalesConf.relatedlists[tab - 1]?.actions?.busy_flag) || false
              }
            ...
            <TableCheckBox
              checked={
                (tab === 0
                  ? freshSalesConf.actions?.activities_participants
                  : freshSalesConf.relatedlists[tab - 1]?.actions?.activities_participants) || false
              }
        ...
        {module === 'Products' && (
          <>
            <TableCheckBox
              checked={
                (tab === 0
                  ? freshSalesConf.actions?.active_flag
                  : freshSalesConf.relatedlists[tab - 1]?.actions?.active_flag) || false
              }
        ...
        {['Leads', 'Deal', 'Contacts', 'Products'].includes(module) && (
          <TableCheckBox
            checked={freshSalesConf.actions?.visible_to || false}
          ...
          <div className="flx flx-between mt-2">
            <MultiSelect
              ...
              defaultValue={getLabelById(
                freshSalesConf.default?.owners,
                tab === 0
                  ? freshSalesConf.moduleData?.owner
                  : freshSalesConf.relatedlists[tab - 1].moduleData?.owner
              )}
              options={freshSalesConf.default?.owners?.map((owner) => ({
                label: owner.label,
                value: owner.value
              }))}
        ...
        {isLoading ? (
          ...
          <div className="flx flx-between mt-2">
            <MultiSelect
              className="msl-wrp-options"
              defaultValue={getLabelById(
                freshSalesConf.default?.leadLabels,
                freshSalesConf.moduleData?.lead_label
              )}
              options={freshSalesConf.default?.leadLabels?.map((label) => ({
                label: label.label,
                value: label.value
              }))}
        ...
        {isLoading ? (
          ...
          <div className="flx flx-between mt-2">
            <MultiSelect
              className="msl-wrp-options"
              defaultValue={getLabelById(
                freshSalesConf.default?.stages,
                freshSalesConf.moduleData?.deal_stage
              )}
              options={freshSalesConf.default?.stages?.map((stage) => ({
                label: stage.label,
                value: stage.value
              }))}
          ...
          <div className="flx flx-between mt-2">
            <MultiSelect
              ...
              defaultValue={getLabelById(
                ...
                tab === 0
                  ? freshSalesConf.moduleData?.activities_type
                  : freshSalesConf.relatedlists[tab - 1].moduleData?.activities_type
              )}
        ...
        {isLoading ? (
          ...
          <div className="flx flx-between mt-2">
            <MultiSelect
              className="msl-wrp-options"
              defaultValue={getLabelById(
                freshSalesConf.default?.currencies,
                tab === 0
                  ? freshSalesConf.moduleData?.currency
                  : freshSalesConf.relatedlists[tab - 1].moduleData?.currency
              )}
              options={freshSalesConf.default?.currencies?.map((currency) => ({
          ...
          <div className="flx flx-between mt-2">
            <MultiSelect
              ...
              defaultValue={getLabelById(
                DealStatuses,
                tab === 0
                  ? freshSalesConf.moduleData?.deal_status
                  : freshSalesConf.relatedlists[tab - 1].moduleData?.deal_status
              )}
          ...
          <div className="flx flx-between mt-2">
            <MultiSelect
              ...
              defaultValue={getLabelById(
                ...
                tab === 0
                  ? freshSalesConf.moduleData?.activities_participants
                  : freshSalesConf.relatedlists[tab - 1].moduleData?.activities_participants
              )}
              options={freshSalesConf.default?.contacts?.map((item) => ({
                label: item.label,
                value: item.value
              }))}
