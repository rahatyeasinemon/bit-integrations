            ...
            <div>
              <Cooltip width={350} icnSize={17} className="ml-2">
                <div className="txt-body">
                  ...
                  <li>Complained = P</li>
                  <p>
                    <strong>Note: </strong>you have to insert one of the mentioned (C, S, U, B, or
                    P) statuses; otherwise, subscriber adding will fail. You can also omit this
                    status field; if omitted, the status will be set to "Confirmed (C)" by default.
                  </p>
                </div>
              </Cooltip>
            </div>
