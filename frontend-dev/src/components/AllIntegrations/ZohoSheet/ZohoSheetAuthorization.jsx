...
export default function ZohoSheetAuthorization({ zohoSheetConf, setZohoSheetConf, step, setStep, loading, setLoading, isInfo, setSnackbar, redirectLocation }) {
  ...
  return (
    <div className="btcd-stp-page" style={{ ...{ width: step === 1 && 900 }, ...{ height: step === 1 && 'auto' } }}>
      ...
      {!isInfo && (
        <div>
          <button onClick={() => handleAuthorization(zohoSheetConf, setZohoSheetConf, setError, setIsAuthorized, loading, setLoading, 'authentication')} className="btn btcd-btn-lg purple sh-sm flx" type="button" disabled={isAuthorized || loading.auth}>
