...
export const getAllCustomActionModules = (
  ...
  setIsLoading(true);
  bitsFetch(customFieldRequestParams, "selesforce_custom_action").then(
    (result) => {
      setIsLoading(false);
      setSalesforceConf((prevConf) =>
        create(prevConf, (draftConf) => {
