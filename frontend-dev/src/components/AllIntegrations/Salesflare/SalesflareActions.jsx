...
export default function SalesflareActions({ salesflareConf, setSalesflareConf, loading, setLoading }) {
  ...
  return (
    <div className="pos-rel d-flx flx-wrp">
      {salesflareConf.actionName === 'lead' && <TableCheckBox checked={salesflareConf.actions?.organizationLead || false} onChange={(e) => actionHandler(e, 'organizationLead')} className="wdt-200 mt-4 mr-2" value="organizationLead" title={__('Lead is an Organization', 'bit-integrations')} subTitle={__('Lead is an Organization', 'bit-integrations')} />}
      ...
      >
        ...
        <div className="flx flx-between mt-2">
          <MultiSelect
            options={salesflareConf?.leadSources?.map(source => ({ label: source, value: source }))}
