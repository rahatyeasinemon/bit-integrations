...
export default function AsanaActions({ asanaConf, setAsanaConf, loading, setLoading }) {
  ...
  return (
    <div className="pos-rel d-flx flx-wrp">
      {asanaConf.actionName === 'organization' && (
        <TableCheckBox
          checked={asanaConf?.selectedParentOrganization?.length || false}
      ...
      {asanaConf.actionName === 'deal' && (
        <TableCheckBox
          checked={asanaConf?.selectedStage?.length || false}
      ...
      <ConfirmModal
        ...
        {loading.parentOrganizations ? (
          ...
          <div className="flx flx-between mt-2">
            <MultiSelect
              options={asanaConf?.parentOrganizations?.map((parentOrganization) => ({
            ...
            />
            <button
              onClick={() => getAllParentOrganizations(asanaConf, setAsanaConf, setLoading)}
              className="icn-btn sh-sm ml-2 mr-2 tooltip"
              style={{
      ...
      <ConfirmModal
        ...
        {loading.currencies ? (
          ...
          <div className="flx flx-between mt-2">
            <MultiSelect
              options={asanaConf?.currencies?.map((currency) => ({
                label: currency.name,
                value: currency.id
              }))}
              className="msl-wrp-options"
