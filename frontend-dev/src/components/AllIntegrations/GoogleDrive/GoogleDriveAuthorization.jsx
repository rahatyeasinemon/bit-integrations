...
export default function GoogleDriveAuthorization({ flowID, googleDriveConf, setGoogleDriveConf, step, setStep, isLoading, setIsLoading, setSnackbar, redirectLocation, isInfo }) {
  ...
  return (
    <div className="btcd-stp-page" style={{ ...{ width: step === 1 && 900 }, ...{ height: step === 1 && 'auto' } }}>
      ...
      {!isInfo && (
        <>
          <button onClick={() => handleAuthorize(googleDriveConf, setGoogleDriveConf, setIsAuthorized, setIsLoading, setError)} className="btn btcd-btn-lg green sh-sm flx" type="button" disabled={isAuthorized || isLoading}>
