...
export default function SystemeIOAuthorization({ systemeIOConf, setSystemeIOConf, step, setStep, loading, setLoading, isInfo }) {
  ...
  return (
    <div className="btcd-stp-page" style={{ ...{ width: step === 1 && 900 }, ...{ height: step === 1 && 'auto' } }}>
      ...
      {!isInfo && (
        <div>
          <button onClick={() => systemeIOAuthentication(systemeIOConf, setSystemeIOConf, setError, setIsAuthorized, loading, setLoading)} className="btn btcd-btn-lg purple sh-sm flx" type="button" disabled={isAuthorized || loading.auth}>
