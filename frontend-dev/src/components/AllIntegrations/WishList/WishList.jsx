...
function WishList({ formFields, setFlow, flow, allIntegURL }) {
  ...
  const [wishlistConf, setWishlistConf] = useState({
    name: 'Wish List',
    type: 'WishList',
    baseUrl: process.env.NODE_ENV === 'development' ? 'https://bit-integration-pro.org/wp-admin/' : '',
    apiKey: process.env.NODE_ENV === 'development' ? 'c5pcEAu61dJI3M24lekbmlki8HldKt2Xs5E7EgUAzDi88zkxDu' : '',
    field_map: [
